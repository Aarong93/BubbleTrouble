(function (root) {
  ...
  Game.prototype.restart = function () {
    ...
    this.NUM_BUBBLES = this.survival ? Math.floor(Math.random() * (5 - 2)) + 2 : 3;
    this.addBubbles();
  ...
  Game.prototype.addBubble = function () {
    var size = this.survival ? Math.floor(Math.random() * (5 - 2)) + 2 : 4;
    var opts = {
      game: this,
      pos: [Math.random() * 400 + 200, 100],
      vel: [-2, 0],
      size: size
    };
